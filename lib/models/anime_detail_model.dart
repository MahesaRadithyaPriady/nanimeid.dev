class AnimeDetailModel {
  ...
  factory AnimeDetailModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      print('Error parsing AnimeDetailModel: $e');
...
class AnimeDetailResponseModel {
  final int status;
  ...
  factory AnimeDetailResponseModel.fromJson(Map<String, dynamic> json) {
    try {
      return AnimeDetailResponseModel(
        status: json['status'] ?? 0,
        message: json['message'] ?? '',
        data: AnimeDetailModel.fromJson(json['data'] ?? {}),
      ...
      print('Error parsing AnimeDetailResponseModel: $e');
      print('JSON data: $json');
      rethrow;
    }
  }
