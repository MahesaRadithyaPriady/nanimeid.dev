...
class _WatchAnimeScreenState extends State<WatchAnimeScreen> {
  ...
  // Komentar akan diambil dari API melalui WatchCommentSection
  ...
  Future<void> _loadRecommendations() async {
    try {
      ...
      final recs = await AnimeService.getRecommendedAnime();
      if (mounted) {
        setState(() {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Fixed (sticky) video player at top
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_recommendations.isNotEmpty)
                      WatchRecommendationSection(
                        recommendations: _recommendations,
                      ),
                    const SizedBox(height: 32),
                    WatchCommentSection(
                      allComments: const [], // legacy param ignored when animeId set
